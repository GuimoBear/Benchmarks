...
public sealed class ByteArrayBloomFilter : IBloomFilter, IEquatable<ByteArrayBloomFilter>
{
    ...
    public ByteArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
    {
    ...
    private ByteArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter, int hashingCount, int bitsCount, byte[] bytes)
    {
        _probabilityOfFalsePositives = probabilityOfFalsePositives;
        _expectedElementsInTheFilter = expectedElementsInTheFilter;
    ...
    public bool Equals(ByteArrayBloomFilter? other)
    {
    ...
    public static ByteArrayBloomFilter Create(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
        => new ByteArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter);

    public static bool TryLoad(string filename, [NotNullWhen(true)] out ByteArrayBloomFilter? filter)
    {
        ...
        filter = new ByteArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter, hashingCount, bitsCount, bytes);
        return true;
    }
}
