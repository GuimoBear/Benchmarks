...
public sealed class BitArrayBloomFilter : IBloomFilter, IEquatable<BitArrayBloomFilter>
{
    ...
    public BitArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
    {
    ...
    private BitArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter, int hashingCount, int bitsCount, byte[] bytes)
    {
        _probabilityOfFalsePositives = probabilityOfFalsePositives;
        _expectedElementsInTheFilter = expectedElementsInTheFilter;
    ...
    public bool Equals(BitArrayBloomFilter? other)
    {
    ...
    public static BitArrayBloomFilter Create(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
        => new BitArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter);

    public static bool TryLoad(string filename, [NotNullWhen(true)] out BitArrayBloomFilter? filter)
    {
        ...
        filter = new BitArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter, hashingCount, bitsCount, bytes);
        return true;
    }
}
