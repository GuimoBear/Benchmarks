...
public sealed class UnoptimizedMurmur3BitArrayBloomFilter : IBloomFilter, IEquatable<UnoptimizedMurmur3BitArrayBloomFilter>
{
    ...
    public UnoptimizedMurmur3BitArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
    {
    ...
    private UnoptimizedMurmur3BitArrayBloomFilter(double probabilityOfFalsePositives, int expectedElementsInTheFilter, int hashingCount, int bitsCount, byte[] bytes)
    {
        _probabilityOfFalsePositives = probabilityOfFalsePositives;
        _expectedElementsInTheFilter = expectedElementsInTheFilter;
    ...
    public void Add(ReadOnlySpan<byte> bytes)
    {
        ...
        {
            var hash = MurmurHash3.Hash32(bytes, i);
    ...
    public bool Equals(UnoptimizedMurmur3BitArrayBloomFilter? other)
    {
    ...
    public static UnoptimizedMurmur3BitArrayBloomFilter Create(double probabilityOfFalsePositives, int expectedElementsInTheFilter)
        => new UnoptimizedMurmur3BitArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter);

    public static bool TryLoad(string filename, [NotNullWhen(true)] out UnoptimizedMurmur3BitArrayBloomFilter? filter)
    {
        ...
        filter = new UnoptimizedMurmur3BitArrayBloomFilter(probabilityOfFalsePositives, expectedElementsInTheFilter, hashingCount, bitsCount, bytes);
        return true;
    }
}
